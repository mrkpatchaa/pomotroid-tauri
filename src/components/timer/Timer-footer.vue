    ...
    <div class="Icon-group" style="position: absolute; right: 0;">
      ...
      <div class="Icon-wrapper Icon-wrapper--double--left" title="Skip the current round" @click="skipRound">
        <svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
          xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 8 12" xml:space="preserve" height="15px"
          class="Icon--skip">
          <polygon fill="var(--color-background-lightest)" points="0,0 0,12 6.1,5.9" />
          <rect x="6.9" y="0" fill="var(--color-background-lightest)" width="1.1" height="12" />
        </svg>
      </div>
      <!-- mute -->
      <div class="Icon-wrapper Icon-wrapper--double--right" :title="volume > 0 ? 'Mute' : 'Unmute'" @click="toggleMute"
        ...
        <transition name="fade" mode="out-in">
          <svg version="1.2" baseProfile="tiny" id="Layer_1" xmlns="http://www.w3.org/2000/svg"
            xmlns:xlink="http://www.w3.org/1999/xlink" x="0px" y="0px" viewBox="0 0 12.3 12" xml:space="preserve"
            height="15px" class="Icon--mute" v-if="localVolume > 0">
            <path fill="var(--color-background-lightest)" d="M0,3.9v4.1h2.7l3.4,3.4V0.5L2.7,3.9H0z M9.2,6c0-1.2-0.7-2.3-1.7-2.8v5.5C8.5,8.3,9.2,7.2,9.2,6z M7.5,0v1.4
