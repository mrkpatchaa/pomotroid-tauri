<template>
  <div>
    <audio id="audio-long-break" ref="audio-long-break" :src="'./audio/alert-long-break.mp3'"></audio>
    <audio id="audio-short-break" ref="audio-short-break" :src="'./audio/alert-short-break.mp3'"></audio>
    <audio id="audio-work" ref="audio-work" :src="'./audio/alert-work.mp3'"></audio>
    <audio id="audio-tick" ref="audio-tick" :src="'./audio/tick.mp3'"></audio>
  </div>
</template>
